            ...
            <ul className="flex flex-col gap-y-4">
              <li>
                <p className="flex items-center gap-2 font-medium text-white">
                  <FaPizzaSlice className="bg-gradient size-10 text-yellow-400 md:size-7 lg:size-6" />
              ...
              <li>
                <p className="flex items-center gap-2 font-medium text-white">
                  <TbTruckDelivery className="size-11 text-yellow-400 md:size-8 lg:size-7" />{" "}
              ...
              <li>
                <p className="flex items-center gap-2 font-medium text-white">
                  <FaCheck className="size-12 text-yellow-400 md:size-8 lg:size-7" />{" "}
