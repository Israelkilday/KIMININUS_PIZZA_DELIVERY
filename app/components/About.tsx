...
const About = () => {
  return (
    <main>
      ...
      <section className="relative h-screen w-full pt-4 lg:container md:pt-12 lg:mb-10 lg:mt-4 lg:h-[450px] lg:pt-0">
        <Image
        ...
        <div className="absolute flex flex-col px-6 py-5 md:w-3/4 md:py-0 lg:w-3/4 lg:px-10 lg:py-10">
