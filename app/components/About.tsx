  ...
  return (
    <main className="relative h-screen w-full pt-4 md:pt-12 lg:mt-4 lg:pt-0">
      ...
      <div className="absolute flex flex-col px-6 py-3 md:w-8/12 md:py-0 lg:w-3/5 lg:px-14 lg:py-8 lg:pt-12">
        <h2 className="mb-4 pt-5 text-center font-bangers text-4xl text-white md:mb-10 md:text-left md:text-[45px] lg:mb-6 lg:pt-1">
          {" "}
          Sobre Nós
        </h2>

        <div className="flex flex-col border-l-2 border-yellow-400 pl-4">
          <p className="mb-4 font-medium text-white lg:text-xl">
          ...
          <div className="flex flex-col gap-4">
            <ul className="flex flex-col gap-y-4">
              <li>
                <p className="flex items-center gap-2 font-medium text-white lg:text-xl">
                  <FaPizzaSlice className="bg-gradient size-10 text-yellow-400 md:size-7 lg:size-9" />
              ...
              <li>
                <p className="flex items-center gap-2 font-medium text-white lg:text-xl">
                  <TbTruckDelivery className="size-11 text-yellow-400 md:size-9 lg:size-9" />{" "}
              ...
              <li>
                <p className="flex items-center gap-2 font-medium text-white lg:text-xl">
                  <FaCheck className="size-12 text-yellow-400 md:size-9 lg:size-10" />{" "}
            ...
            <p className="mb-10 font-medium text-white md:mb-14 lg:mt-3 lg:text-xl">
              {" "}
